...
public class AccountDao extends AbstractDao<Account, Long> {
    ...
    public static class Properties {
        public final static Property AccId = new Property(0, Long.class, "accId", true, "_id");
        ...
        public final static Property OperateFlag = new Property(7, Long.class, "operateFlag", false, "OPERATE_FLAG");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ACCOUNT\" (" + //
                "\"_id\" INTEGER PRIMARY KEY ," + // 0: accId
    ...
    protected final void bindValues(DatabaseStatement stmt, Account entity) {
        ...
        Long operateFlag = entity.getOperateFlag();
        if (operateFlag != null) {
    ...
    public Account readEntity(Cursor cursor, int offset) {
        Account entity = new Account( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // accId
            ...
            cursor.isNull(offset + 7) ? null : cursor.getLong(offset + 7), // operateFlag
    ...
    public void readEntity(Cursor cursor, Account entity, int offset) {
        entity.setAccId(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
        ...
        entity.setOperateFlag(cursor.isNull(offset + 7) ? null : cursor.getLong(offset + 7));
    ...
    public List<Account> _queryUser_AccountList(Long accId) {
        synchronized (this) {
